...
const CardsOfHousses = ({title , description , menuCards , key}) => {
    ...
    return (
        <div className='cards-housses' >
             <div className='w-full flex sm:flex-row sm:justify-between sm:items-center flex-col  '>
                 ...
                 <div  className='animate-x hover:scale-[1.7] cursor-pointer transition-[0.5s] sm:mt-[0] mt-[20px]'>
